		...
		<div>
			<form action="" method="post" style="height: 205px">
				...
				<table class="auto-style1">
					<tr>
						<td><p>Genero:</p></td><td><input name="NombreGenero" style="width: 300px" type="text" /></td>
					</tr>
					<tr>
						<td>Descripcion:*</td><td><textarea rows="3" name="DescripcionGenero" style="width: 300px"></textarea></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td><td>
						<input name="CrearGenero" type="button" value="Crear" /></td>
					</tr>
				</table>
			</form>
		</div>
